...
class MyDataset(Dataset):
    ...
    def collate_fn(self,batch):
        ...
        label_emotions=pad_sequence([torch.LongTensor(emo) for emo in y_emotions],batch_first=True,padding_value=-1) 
        label_causes=pad_sequence([torch.LongTensor(cau) for cau in y_causes],batch_first=True,padding_value=-1)
